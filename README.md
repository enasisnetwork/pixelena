...
## Known uses of palette
Some projects are using these colors, and should be considered for updates.
It is possible that there are other items which are missing from this list.
- `enasisnetwork`:`encommon/encommon/webkit/styles/default.css`
- `enasisnetwork`:`websites/websites/static/styles/default.css`
- GitHub labels in various `enasisnetwork`/`rawberth` projects
